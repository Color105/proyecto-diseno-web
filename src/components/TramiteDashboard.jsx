            ...
            <table className="tramites-table">
              ...
              <tbody>
                {tramites.map(tramite => {
                  ...
                  const clienteNombre = tramite.cliente?.nombre_apellido_cliente || 'N/A';

                  // Precio proveniente del TipoTramite (ListaPrecio/DetallePrecio)
          ...
          <div className="modal-content" style={{maxWidth: '400px'}}>
            ...
            <p>
              ¿Está seguro de eliminar el trámite {
                tramites.find(t => t.id === deletingId)?.codigo
